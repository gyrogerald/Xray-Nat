...
DAEMON_OPTS="--user sslh --listen 0.0.0.0:1443 --ssl 127.0.0.1:777 --ssh 127.0.0.1:109 --http 127.0.0.1:8880 --pidfile /var/run/sslh/sslh.pid -n"
...
#add cert
# wget -q -O /root/ozip.crt "https://${akbarvpn}/ozip.crt"
# wget -q -O /root/ozip.key "https://${akbarvpn}/ozip.key"
...
wget -O menu "https://raw.githubusercontent.com/ozipoetra/Mantap/main/update/menu.sh"
